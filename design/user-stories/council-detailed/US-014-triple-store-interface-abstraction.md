...
Implement an abstraction layer for the triple store that allows different
implementations to be swapped easily. This enables flexibility in storage choice
(SQLite, RDF4J, etc.) without changing query logic.
...
- **Performance characteristics**: Backends may have different performance
    profiles
