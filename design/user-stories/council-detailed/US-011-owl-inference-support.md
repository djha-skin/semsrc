...
Implement OWL (Web Ontology Language) inference support to automatically
calculate derived relationships based on semantic rules. This allows the system
to infer new facts from existing data using ontological reasoning.
...
3. **Transitive closure**: Calculate transitive relationships (e.g., ancestor
   : chains)
...
- Support common OWL constructs (subclass, property domains/ranges, transitive
   properties)
...
- **Incremental updates**: Should efficiently update inferences when data
    changes
