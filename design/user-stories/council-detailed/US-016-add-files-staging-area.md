...
Add files to the staging area to prepare for commit. The staging area tracks
files that will be included in the next commit, allowing selective commits and
partial commits.
